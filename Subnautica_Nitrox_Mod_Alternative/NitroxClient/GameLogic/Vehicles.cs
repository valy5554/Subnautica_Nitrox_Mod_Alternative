...
public class Vehicles
{
    ...
    {
        // Игнорируем пакет если он о нас самих — локальный игрок управляет своим транспортом
        // через стандартную физику игры, а не через RemotePlayer анимацию.
        // Без этой проверки на хосте появлялся «призрак» клиента в кресле пилота.
        if (sessionId == multiplayerSession.Reservation.SessionId)
        {
            return;
        }
